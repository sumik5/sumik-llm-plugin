...
description: >-
  Web API design best practices for endpoints, responses, HTTP spec usage, versioning, and security.
  Use when designing REST-style HTTP APIs or creating new endpoints.
