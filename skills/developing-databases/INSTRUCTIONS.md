...
### PostgreSQL実践運用 references/

| ファイル | 内容 |
|---------|------|
| [POSTGRESQL-FUNDAMENTALS.md](./references/POSTGRESQL-FUNDAMENTALS.md) | 用語差分、データ型、サーバー設定、DB作成 |
| [POSTGRESQL-EXTENSIONS.md](./references/POSTGRESQL-EXTENSIONS.md) | 拡張機能ライフサイクル、主要拡張ガイド |
| [POSTGRESQL-CORE-OBJECTS.md](./references/POSTGRESQL-CORE-OBJECTS.md) | テーブル、インデックス6種、ビュー、トリガー等 |
| [POSTGRESQL-QUERY-TUNING.md](./references/POSTGRESQL-QUERY-TUNING.md) | EXPLAIN、スキャン/ジョインノード、インデックス戦略 |
