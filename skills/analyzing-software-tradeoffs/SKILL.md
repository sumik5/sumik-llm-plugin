...
description: >-
  ...
  versioning), distributed systems (consistency, delivery semantics), and meta-decisions
  (library selection, trend evaluation, date-time handling). Use when evaluating
  design alternatives, making architectural decisions, or reviewing trade-offs in
