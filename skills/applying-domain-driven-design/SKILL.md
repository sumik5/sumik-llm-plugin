...
description: >-
  ...
  For socio-technical architecture modernization, trade-off analysis, and microservices distributed patterns (Saga, messaging, granularity), use architecting-infrastructure instead.
