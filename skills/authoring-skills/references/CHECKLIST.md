...
- [ ] disable-model-invocation set correctly for task-type skills
- [ ] user-invocable set to false for background knowledge skills
- [ ] allowed-tools restricts tools appropriately (if using context: fork)
- [ ] context: fork set for subagent execution skills
- [ ] agent type specified when using context: fork
- [ ] hooks defined correctly (if skill-scoped hooks needed)
