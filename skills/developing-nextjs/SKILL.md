...
description: >-
  Next.js 16.x development guide covering App Router, Server Components, Turbopack, React Compiler, proxy.ts,
  Cache Components, opt-in caching APIs (updateTag/revalidateTag/refresh), strict TypeScript, Tailwind CSS 4.x,
