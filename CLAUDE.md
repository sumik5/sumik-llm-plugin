...
- **13 プラグイン（devkit / studio / lang / web / cloud / ai / design / product / exam / university / google / mobile / certificate）はそれぞれ独立した version を持つ**（別プラグインのため別系列で進める。現状: devkit 14.14.0・studio 2.1.1・lang 2.4.0・web 1.4.1・cloud 1.2.1・ai 1.2.3・design 1.0.2・product 1.0.2・exam 1.2.2・university / google は 1.0.0・mobile は 1.3.0・certificate は 2.1.0）
...
コミット前に 13 プラグインの version 一致を確認すること（`.agents/plugins/marketplace.json` の `plugins[]` 配列は順序依存しないよう name で引く）。期待値: devkit 14.14.0・studio 2.1.1・lang 2.4.0・web 1.4.1・cloud 1.2.1・ai 1.2.3・design 1.0.2・product 1.0.2・exam 1.2.2・university / google は 1.0.0・mobile は 1.3.0・certificate は 2.1.0:
...
expected = {"devkit": "14.14.0", "studio": "2.1.1", "lang": "2.4.0", "web": "1.4.1",
            "cloud": "1.2.1", "ai": "1.2.3", "design": "1.0.2",
            "product": "1.0.2", "exam": "1.2.2", "university": "1.0.0",
            "google": "1.0.0", "mobile": "1.3.0", "certificate": "2.1.0"}
all_ok = True
