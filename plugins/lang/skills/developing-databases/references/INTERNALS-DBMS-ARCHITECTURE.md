...
電話番号: [+1 111 222 333, +1 555 888 999, +1 333 444 555]
```
...
#### 2. ハッシュ構造ファイル（Hash-Organized File）
...
- **目的**: データベースベンダーが自社の製品のパフォーマンスを比較評価するために使用される一連のベンチマークを策定
