...
description: >-
  Creates distinctive, production-grade frontend code with shadcn/ui integration,
  object-oriented UI (OOUI) methodology, and micro-frontend architecture patterns.
  Use when implementing web components, pages, or applications requiring creative,
  polished UI code; when designing UI structure using object-oriented approach
