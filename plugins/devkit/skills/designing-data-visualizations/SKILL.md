...
description: >-
  ...
  or any visual data representation. For UI/UX design principles, use designing-ux instead.
  For technical diagrams (flowcharts, architecture), use studio:creating-diagrams instead.
---
