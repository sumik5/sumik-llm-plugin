...
| Webビジュアルデザイン実践 | Web特化のレイアウト・配色・UIコンポーネント・モーション | Webページ制作・デザインコンセプト策定 |
...
| 参照先スキル | 参照タイミング |
|------------|--------------|
| `web:designing-frontend` | フロントエンドコード実装（shadcn/ui、コンポーネント設計） |
| `applying-behavior-design` | 行動変容設計（習慣化、CREATE Action Funnel） |
| `designing-ai-experiences` | AI体験のUXフレームワーク（AIインターフェース・Agentic UX） |
| `building-design-systems` | デザインシステム構築・ガバナンス |
| `practicing-design-thinking` | デザイン思考プロセス・ユーザーリサーチ・UX実践手順 |
...
> **スキル分割済み**: デザイン思考プロセス（d.school/IDEO 5ステップ）・ユーザーリサーチ・UXメソッド実践は `practicing-design-thinking` スキルに移管しました。

---

## AIエクスペリエンス設計

> **スキル分割済み**: AIプロダクトUXデザイン（AIインターフェース・Input/Computation/Output設計）は `designing-ai-experiences` スキルを参照してください。
...
> **スキル分割済み**: UX実践原則（Consider/Empathize/Define/Research/Design/Validate）は `practicing-design-thinking` スキルに移管しました。
...
> **スキル分割済み**: ユーザビリティ評価・ユーザーリサーチ・カスタマージャーニーマップ・共感ペルソナ・組織導入等の実践手順は `practicing-design-thinking` スキルを参照してください。
